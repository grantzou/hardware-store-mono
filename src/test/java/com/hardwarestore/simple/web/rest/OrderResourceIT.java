...
import static com.hardwarestore.simple.web.rest.TestUtil.sameNumber;
...
import com.hardwarestore.simple.domain.enumeration.OrderStatus;
import com.hardwarestore.simple.repository.OrderRepository;
import com.hardwarestore.simple.service.OrderService;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().orderDate(DEFAULT_ORDER_DATE).status(DEFAULT_STATUS).totalPrice(DEFAULT_TOTAL_PRICE);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().orderDate(UPDATED_ORDER_DATE).status(UPDATED_STATUS).totalPrice(UPDATED_TOTAL_PRICE);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.orderDate(UPDATED_ORDER_DATE).status(UPDATED_STATUS).totalPrice(UPDATED_TOTAL_PRICE);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderDate(UPDATED_ORDER_DATE).totalPrice(UPDATED_TOTAL_PRICE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderDate(UPDATED_ORDER_DATE).status(UPDATED_STATUS).totalPrice(UPDATED_TOTAL_PRICE);
